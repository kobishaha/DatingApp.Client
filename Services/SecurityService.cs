...
namespace DatingApp.Client
{
    public partial class SecurityService(NavigationManager navigationManager, IHttpClientFactory factory)
    {
        ...
        private readonly HttpClient httpClient = factory.CreateClient("DatingApp.Client");

        private readonly Uri baseUri = new Uri($"{navigationManager.BaseUri}odata/Identity/");
